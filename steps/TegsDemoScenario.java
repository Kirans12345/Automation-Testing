...
public class TegsDemoScenario {
	...
	@Then("I click on the my account link")
	...
	@Then("I will be on the login page and I capture title of the page")
	...
	@Then("I enter email id as {string} on page")
